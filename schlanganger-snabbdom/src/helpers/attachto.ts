...
import { DestroyHook, PostPatchHook, PrePatchHook, CreateHook } from '../hooks';
...
export function attachTo(target: Element, vnode: VNode): VNode {
  ...
  hook.create = create as CreateHook;
  hook.prepatch = pre as PrePatchHook;
  hook.postpatch = post as PostPatchHook;
  hook.destroy = destroy as DestroyHook;
  return vnode;
};

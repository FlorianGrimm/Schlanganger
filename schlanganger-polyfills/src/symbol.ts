(function (Object, GOPS, globalScope: any) {
  'use strict';
  ...
  var
    ...
    gOPN = (Object as any)[GOPN],
    gOPD = (Object as any)[GOPD],
    create = Object.create,
    keys = Object.keys,
    defineProperty = (Object as any)[DP],
    $defineProperties = (Object as any)[DPies],
    descriptor = gOPD(Object, GOPN),
    ObjectProto = Object.prototype,
    hOP = ObjectProto.hasOwnProperty,
    pIE = (ObjectProto as any)[PIE],
    toString = ObjectProto.toString,
    indexOf = Array.prototype.indexOf || function (this: any, v: any) {
      for (var i = this.length; i-- && this[i] !== v;) { }
      return i;
    },
    addInternalIfNeeded = function (o: any, uid: any, enumerable: any) {
    ...
    createWithSymbols = function (proto: any, descriptors: any) {
      var self = create(proto);
      if (descriptors !== null && typeof descriptors === 'object') {
        gOPN(descriptors).forEach(function (key: any) {
    ...
    copyAsNonEnumerable = function (descriptor: any) {
      var newDescriptor = create(descriptor);
      newDescriptor.enumerable = false;
      return newDescriptor;
    },
    get = function get() { },
    onlyNonSymbols = function (name: any) {
      return name != internalSymbol &&
        !hOP.call(source, name);
    },
    onlySymbols = function (name: any) {
      return name != internalSymbol &&
        hOP.call(source, name);
    },
    propertyIsEnumerable = function propertyIsEnumerable(this: any, key: any) {
      var uid = '' + key;
    ...
    setAndGetSymbol = function (uid: any) {
      var descriptor = {
        enumerable: false,
        configurable: true,
        get: get,
    ...
    Symbol = function Symbol(this: any, description: any) {
      if (this && this !== G) {
        throw new TypeError('Symbol is not a constructor');
      }
      return setAndGetSymbol(
        prefix.concat(description || '', random, (++id).toString())
      );
    },
    source = create(null),
    sourceConstructor = { value: Symbol },
    sourceMap = function (uid: any) {
      return source[uid];
    },
    $defineProperty = function defineProp(o: any, key: any, descriptor: any) {
      var uid = '' + key;
      if (onlySymbols(uid)) {
    ...
    $getOwnPropertySymbols = function getOwnPropertySymbols(o:any) {
  ...
  descriptor.value = function getOwnPropertyNames(o:any) {
    return gOPN(o).filter(onlyNonSymbols);
  };
  defineProperty(Object, GOPN, descriptor);

  descriptor.value = function defineProperties(o: any, descriptors: any) {
  ...
  descriptor.value = function (key: any) {
  ...
  descriptor.value = function (symbol: any) {
  ...
  descriptor.value = function getOwnPropertyDescriptor(o: any, key: any) {
  ...
  descriptor.value = function (proto: any, descriptors: any) {
  ...
  try { // fails in few pre ES 5.1 engines
    ...
    setDescriptor = function (o: any, key: any, descriptor: any) {
      var protoDescriptor = gOPD(ObjectProto, key);
      delete (ObjectProto as any)[key];
      defineProperty(o, key, descriptor);
        ...
        case toStringTag:
          ...
          if (descriptor){
            descriptor.value = function () {
              ...
              tst = typeof this === 'undefined' || this === null ? undefined : (this as any)[Symbol.toStringTag]
              ;
...
(function (Si: any, AP: any, SP: any) {

  function returnThis(this: any): any { return this as any; }
